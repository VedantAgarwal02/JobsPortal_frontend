  ...
  return (
    <div>
        <Navbar expand="sm" bg="dark" data-bs-theme="dark" className="bg-body-secondary">
            <Container fluid>
            <Navbar.Brand onClick={() => navigate('/dashboard')}> <Nav.Link> Jobs Portal </Nav.Link> </Navbar.Brand> 
            ...
            <Navbar.Collapse id="navbarScroll">
                ...
                {buttonVal && <Button variant="outline-success" onClick={() => navFunc()}>{buttonVal}</Button>}
                </Form>
            </Navbar.Collapse>
            </Container>
        </Navbar>
